...
const Social = ()=> {
    const socialLinks = [
        {link:"https://github.com/Ankit-tech175", icon:IconBrandGithub},
        {link:"https://www.linkedin.com/in/ankit-chauhan-5043282a1", icon:IconBrandLinkedin},
        {link:"https://www.instagram.com/ankitchauhan_45/", icon:IconBrandInstagram},
        {link:"https://leetcode.com/u/Ankitchauhan19/", icon:IconBrandLeetcode},
    ];
